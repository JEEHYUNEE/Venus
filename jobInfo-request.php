                ...
                <div class="col-md-5 mb-5 ml-auto mr-auto">
                    <form  method="post">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="name" class="form-control" placeholder="Write your Name." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 mb-4 mb-lg-0">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="email" class="form-control" placeholder="Write your Email." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-3 mb-4 mb-lg-0">
                            ...
                            <div class="col-md-9">
                                <input type="text" id="phone" class="form-control" placeholder="Write your Tel." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-4 p-0">
                                <input type="text" id="companyName" class="form-control" placeholder="Write your Company Name." required>
                            </div>
                            <div class="col-md-2 mb-4 mb-lg-0">
                                <p class="form-control" style="pointer-events: none;">직급</p>
                            </div>
                            <div class="col-md-4 p-0 pr-3">
                                <input type="text" id="position" class="form-control" placeholder="Write your Position." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-2 mb-4 mb-lg-0">
                            ...
                            <div class="col-md-10">
                                <input type="text" id="title" class="form-control" placeholder="Write your Title." required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-2 mb-4 mb-lg-0">
                            ...
                            <div class="col-md-10">
                                <textarea type="text" name="content" id="contents" class="form-control" rows="20" placeholder="Write your Content." required></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-6 ml-auto mr-auto">
                                <input id='id-register' type="submit" class="btn btn-block btn-primary text-white py-3 px-5" value="Register">
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    document.getElementById('id-register').addEventListener('click',function(){
        ...
        $.ajax({
                    url: "/venus/db/jobinfo_request/insert.php",
                    type: "POST",
                    data: formData,
                    processData: false,
                    contentType: false,
