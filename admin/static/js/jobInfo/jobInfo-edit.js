document.getElementById('id-edit-jobInfo').addEventListener('click',function(){
    ...
    formData.append('jobInfoId',new URL(document.URL).searchParams.get('id') ); //append file to formData object


    $.ajax({
        url: "/venus/admin/db/jobInfo/edit.php",
        type: "POST",
        data: formData,
        processData: false, 
        contentType: false, 
