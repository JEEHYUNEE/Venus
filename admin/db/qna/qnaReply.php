<!doctype html>
    ...
    <body>
        ...
        <h1 class="h3 mb-2 text-gray-800 mt-3">Q&A 댓글관리</h1>
        <p class="mb-5">Q&A 댓글 수정/삭제가 가능한 공간입니다.</p>
            <div class="reply_view">
                <?php
                    $sql = mq("select * from qna_reply where qna_num='".$num."' order by idx desc");
                ...
                ?>
                    <form method="post">
                        ...
                        <div class="bt_se">
                            <input type="submit" value="수정" formaction='./qnaReplyModifyOk.php'>
                            <input type="submit" value="삭제" formaction='./qnaReplyDeleteOk.php'>
                        </div>
                        <hr/>
                    </form>
                <?php } ?>
