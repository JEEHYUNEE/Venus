<!doctype html>
    <?php 
        ...
        $num = $_GET['num']; 
        $sql = mq("select * from news where newsNum='".$num."'");
...
<script src="http://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.8/summernote.js"></script>
    ...
    <body>
        ...
        <h1 class="h3 mb-2 text-gray-800 mt-3">취업뉴스</h1>
        <p class="mb-3">취업뉴스 수정/삭제가 가능한 공간입니다.</p>
            <div id="write_area">
            <form method="post">
                    <div id="in_num">
                        <input type="hidden" name="num" class="border-0" value="<?php echo $board['newsNum'];?>" style="width:75px" readonly/>  
                    </div>
                    <div id="in_title">
                    ...
                    <div class="bt_se m-2 mb-3">
                        <input type="submit" value="수정" formaction='./newsModifyOk.php'>
                        <input type="submit" value="삭제" formaction='./newsDeleteOk.php'>
                    </div>
            </form>
            </div>
