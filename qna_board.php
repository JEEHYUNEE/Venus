       ...
       <div class="ftco-blocks-cover-1">
        ...
        <div class="site-section bg-light text-center">
            <div> 
                ...
                <div  class="col-md-10 text-right mb-2 p-0">
                    <button class="bg-dark text-white p-2" onclick="location.href='./qna_write.php'">질문작성</button>
                </div>
                <table class="col-md-8 text-center table-striped m-auto">
                    ...
                    <tbody style="border:1px solid #00000008">
                        <?php
                            ...
                            $sql = mq("select * from qna order by qnaNum desc limit $start_num, $list"); 
                                    ...
                                    {   
                                        ...
                                        echo "<td><a href='./qna_read.php?num=".$num."'>".$title."</a></td>";
                                        echo "<td>".$board['userId']."</td>";
                                        echo "<td>".$board['date']." </td>";
                                        echo "<td>".$board['hit']." </td>";
                                        echo "</tr>";
                                        //qna 답변이 있는경우 답변표시
                                        if($board['answerCheck']=='Y'){
                                            $sql1 = mq("select * from qna_answer where qna_num='".$num."'"); 
                                            $answer = $sql1->fetch_array();
                                            ...
                                            echo "<tr>";
                                            echo "<td class='p-2' style='color:#CD0316; font-weight:700; font-size:20px;'>&nbsp;↳</td>";
                                            echo "<td><a href='./qna_answer_read.php?num=".$answer['qna_num']."'>".$answer['title']."</a></td>";
                                            echo "<td>관리자</td>";
                                            echo "<td>".$answer['date']." </td>";
                                            echo "<td>".$answer['hit']." </td>";
                                            echo "</tr>";
