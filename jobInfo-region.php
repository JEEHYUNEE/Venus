        ...
        <div class="site-section ">
            <div class="container ">
                ...
                <div class="row justify-content-center text-center">
                    ...
                    <select id='id-region' class="form-control form-control-title">
                        <?php
                         for($i=0;$i<sizeof($region=getRegion());$i++){
                        ?>
                            <option> <?php echo $region[$i]['regionName'] ?> </option>
                        <?php
                         }
                        ?>
                    </select>
                ...
                <div class="row">
                    <div class="col-md-12 mb-5">
                         <iframe id='id-frame' style="height:450px; border:none;" class="form-control" src="jobinfo-frame-region.php">
                         </iframe>
                    </div>
                </div>
            </div>
