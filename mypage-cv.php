    ...
    <div>
        <div class="row justify-content-center mt-2 mb-5">
            <div id="news" class="col-md-8 mt-5 text-center heading-section ftco-animate fadeInUp ftco-animated">
                <span class="subtitle">CV Management</span>
                <h2 class="mb-4">이력서관리</h2>
                <div class="form-group row">
                <div class="col-md-10" ></div>
                <div class="col-md-2" >
                    <a  class='btn btn-block btn-primary text-white pl-1 py-1 px-0'
                                 id='id-insert-cv' >이력서등록</a>
                </div>
            </div>
            </div>
        </div>
        ...
        <table class="col-md-8 text-center table-striped m-auto">
                    <thead>
                        <tr class="bg-dark text-white">
                            <th width="100"  class="p-3">이력서제목</th>
                            <th width="70">등록날짜</th>
                            <th width="50">관리</th>
                        </tr>
                        <tr>
                    ...
                    <tbody style="border:1px solid #00000008">
                        <?php
                            ...
                            for($i=0;$i<sizeof($cv2=getCV_limit($loginId, $start_num, $list));$i++){
                                ...
                                echo "<td><a href='db/cv/delete.php?id=".$cv2[$i]['cvId']."'>삭제</a></td>";
                            }
                        ?>
                    </tbody>
                </table>
...
<script src="static/js/cv/cv.js"></script>
