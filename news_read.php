                ...
                <div id="board_read">
                    ...
                    <div id="bo_ser" class="mt-5">
                        <ul>
                            <?php
                                if($pre>=1){
                                    echo "<li><a href='./news_read.php?num=".$pre."#board'>[이전글]</a></li>";
                                }
                            ?>
                            <li><a href="./news_board.php">[목록으로]</a></li>
                            <?php
                                if($next<=$row_num){
                                    echo "<li><a href='./news_read.php?num=".$next."#board'>[다음글]</a></li>";
                                }
                            ?>
                        </ul>
                    </div>
