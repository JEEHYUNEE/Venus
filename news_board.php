                ...
                <table class="col-md-8 text-center table-striped m-auto">
                    ...
                    <tbody style="border:1px solid #00000008">
                        <?php
                            ...
                            $sql = mq("select * from news order by newsNum desc limit $start_num, $list"); 
                                    ...
                                    {   
                                        ...
                                        echo "<td><a href='./news_read.php?num=".$num."'>".$title."</a></td>";
                                        echo "<td>관리자</td>";
